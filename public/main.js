class Game extends Phaser.Scene {
  ...
  generateDevilAndProducts() {
    ...
    let devilX = this.player.x + 700 + this.randomBetween(1, 50);
    let devilY = this.randomBetween(100, 1000);
    let productX = this.player.x + 700 + this.randomBetween(1, 50);
    let productY = this.randomBetween(100, 1000);
    while (productY > devilY - 50 && productY < devilY + 50) {
      productY = this.randomBetween(100, 1000);
    }
    let productCome = false;
    if (this.randomBetween(1, 10) < 5) {
      productCome = true;
    }
    this.generateDevil(devilX, devilY);
